...
import { useInsuranceRecommendations } from '../../hooks/useInsurance'
...
export function AiRoutePlanner() {
  ...
  const { data: insuranceResponse } = useInsuranceRecommendations(selectedCountry)
  const insurancePackages = insuranceResponse?.data || []
          ...
          {insurancePackages.length > 0 && (
            <div className="bg-green-50 rounded-2xl p-6">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-lg font-medium text-gray-900">Travel Insurance Recommendations</h4>
              </div>
              <p className="text-sm text-gray-600 mb-4">
                Recommended insurance packages for your trip to {selectedCountry.charAt(0).toUpperCase() + selectedCountry.slice(1)}
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {insurancePackages.slice(0, 2).map((insurance: InsurancePackage) => (
